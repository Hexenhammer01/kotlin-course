package com.rail.kotlincourse.lesson29
...
//    val isoFormattedDate = birthday.format(isoFormatter)
...
//    println(parsedDate)
//
    val vremennayametka = Instant.now()

    val customInstant = Instant.ofEpochSecond(123123123)
    println(customInstant)
    val denZnaniy = LocalDate.of(2024,9,1)
    val poslednidenvesny = LocalDate.of(2025,5,20)
    val raznicaDat = Period.between(denZnaniy,poslednidenvesny)
    println(raznicaDat.toTotalMonths())
    val ruchnPer = Period.of(2,3,330)
